...
public class Processing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagemOriginal = (ImageView) findViewById(R.id.inputImage);
        imagemResult = (ImageView) findViewById(R.id.outputImage);

        saveToFirebase = (Button) findViewById(R.id.save_to_firebase);
